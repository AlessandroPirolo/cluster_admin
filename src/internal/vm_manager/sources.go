...
func (this *sources) getPoolXml() (string, error) {
  cont, err := os.ReadFile("src/internal/vm_manager/sources/pool.xml")
  return string(cont), err
}

func (this *sources) getVolXml() (string, error) {
  cont, err := os.ReadFile("src/internal/vm_manager/sources/vol.xml")
...
func (this *sources) getDomXml() (string, error) {
  cont, err := os.ReadFile("src/internal/vm_manager/sources/dom.xml")
